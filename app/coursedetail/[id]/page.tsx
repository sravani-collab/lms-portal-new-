...
// Your mock data from before, just cleaned up a bit for usage here
...
export default function CourseDetailPage() {
  ...
  // Find current lesson title or fallback
          ...
          <div className="lg:col-span-3 space-y-6 bg-white rounded-2xl p-8 shadow min-h-[400px] flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-700">
                {/* You can replace this with actual lesson content or embed videos, text, etc. */}
                {selectedLesson
            ...
            <div className="flex justify-between pt-6 border-t border-gray-200">
              <button
                onClick={() => {
                  // Find previous lesson id (simple linear search)
